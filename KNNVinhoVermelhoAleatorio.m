for j=1:3000
    ...
    parametros_treino = r(1:tam_treino);
    parametros_validacao = r(tam_treino+1:tam_validacao+tam_treino);
    parametros_teste = r(tam_validacao+tam_treino+1:end);

    X_train = X(parametros_treino, :);
    Y_train = Y(parametros_treino, :);
    X_train_validation = X(parametros_validacao, :);
    ...
    dlmwrite(arquivo_parametros, [hiper_K hiper_P num_dimensoes parametros_treino parametros_validacao parametros_teste])
